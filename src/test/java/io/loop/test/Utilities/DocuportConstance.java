...
public class DocuportConstance {
    ...
    public static final String LOGO_DOCCUPORT= "Docuport";
    ...
    public static final String XXXXXXXXXXXX= "We've sent you an email with a link to reset your password. Please check your email.";
